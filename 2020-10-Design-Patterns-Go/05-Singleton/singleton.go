...
// both init and sync.Once init() -> thread-safe
// but only sync.Once is lazy -> no tiene garantia que sea seguro el thread
...
// De esta manera nos es mas facil implementar pruebas
