...
// Siempre y cuando este en la posicion que nos interesa
...
func main() {
	...
	fmt.Println(ft.String()) // Imprime: This is a BRAVE new world
	// Imagina si tenemos miles y miles de texto, no es performante

	//Lo que podemos hacer es tomar un rango de texto,
	//Usamos menos memoria, guardando en pequeños objetos temporales lo que nos
	//permite ahorrar mucha memoria
