...
func main() {
	...
	// Si utilizo esto no se realizan modificaciones, lo corto antes en la
	// cadena de responsabilidades (chain of responsability)
	//root.Add(NewNoBonusesModifier(goblin))

	// Genero una funcionalidad para realizar cada modificacion del objeto
